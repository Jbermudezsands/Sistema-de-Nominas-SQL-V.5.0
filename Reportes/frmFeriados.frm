...
Begin VB.Form Form1 
   Caption         =   "Actualizar Feriado 14 y 15 de Septiembre"
   ClientHeight    =   3165
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   7320
...
Do While Not Me.adoEmpleado.Recordset.EOF
   ...
   Me.adoTurno.RecordSource = "SELECT CodEmpleado, MCEntrada, MCSalida, JEntrada, JSalida FROM HorarioEmpleado WHERE CodEmpleado ='" & Me.adoEmpleado.Recordset.Fields("CodEmpleado") & "'"
   Me.adoTurno.Refresh
   
   Me.adoAsistencia.CommandType = adCmdText
   Me.adoAsistencia.RecordSource = "SELECT * FROM AsistenciaEmpleado WHERE FechaEntrada = CONVERT(DATETIME, '" & "2005-09-14" & " 00:00:00" & "', 102) AND CodEmpleado ='" & Me.adoEmpleado.Recordset.Fields("CodEmpleado") & "'"
  ...
  Do While bConta < 2
   ...
   If Me.adoAsistencia.Recordset.EOF Then
      ...
      Me.adoAsistencia.Recordset.Fields("FechaEntrada") = "14/09/2005"
      Me.adoAsistencia.Recordset.Fields("HoraEntrada") = Me.adoTurno.Recordset.Fields("MCEntrada")
      Me.adoAsistencia.Recordset.Fields("FechaSalida") = "14/09/2005"
...
Me.adoEmpleado.RecordSource = "SELECT CodEmpleado, Activo, CodTipoNomina FROM Empleado WHERE Activo =1"
