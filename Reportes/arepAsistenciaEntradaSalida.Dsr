VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} arepAsistenciaEntradaSalida 
   Caption         =   "Asistencia"
   ClientHeight    =   11115
   ClientLeft      =   165
   ClientTop       =   450
   ...
   _ExtentX        =   26882
   _ExtentY        =   19606
   SectionData     =   "arepAsistenciaEntradaSalida.dsx":0000
End
Attribute VB_Name = "arepAsistenciaEntradaSalida"
...
If IsNumeric(Me.txtTHLaboradas.Text) Then
   If txtTHLaboradas.Text = "0" Then
      Exit Sub
   End If
...
If Me.txtNomina.Text = "Administracion" Then
