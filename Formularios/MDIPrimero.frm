...
'    '///////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    TabHome.Id = 1500
     ...
     item.Style = xtpButtonIconAndCaptionBelow
     RibbonBar.QuickAccessControls.Add XtremeCommandBars.XTPControlType.xtpControlButton, ID_FILE_SAVE, "Zeus Nominas V.6.19", False, False
...
If Format(Now, "dd/mm/yyyy") > CDate("24/12/2020") Then
  PreguntaSalir = False
  Unload Me
End If
