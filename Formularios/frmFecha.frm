...
Begin VB.Form frmFecha 
   ...
   Begin VB.Frame fraPlanilla 
      ...
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel4 
         Height          =   255
         Left            =   4200
         OleObjectBlob   =   "frmFecha.frx":0000
         TabIndex        =   14
         Top             =   960
         Width           =   855
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel3 
         Height          =   255
         Left            =   2160
         OleObjectBlob   =   "frmFecha.frx":0072
         TabIndex        =   13
         Top             =   960
         Width           =   1695
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel2 
         Height          =   255
         Left            =   240
         OleObjectBlob   =   "frmFecha.frx":00E6
         TabIndex        =   12
         Top             =   960
         Width           =   1575
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel1 
         Height          =   375
         Left            =   120
         OleObjectBlob   =   "frmFecha.frx":0162
         TabIndex        =   11
         Top             =   480
         Width           =   1575
      End
      Begin MSDataListLib.DataCombo DBTipoNomina 
         Bindings        =   "frmFecha.frx":01DC
   ...
   Begin SmartButtonProject.SmartButton cmdGuardar 
      ...
      EndProperty
   End
   Begin SmartButtonProject.SmartButton CmdImprimir 
      Height          =   735
      Left            =   3840
      TabIndex        =   15
      Top             =   5640
...
Dim Fechas As Date, FechaAnterior As Date
...
Select Case TipoNomina
 Case "Semanal Sabado"
       ...
       End If
        ...
        Me.DtaAño.RecordSource = "SELECT CodTipoNomina,Año, Actual, FecIni, FecFin From Año_Actual Where (Actual = 1) AND (CodTipoNomina='" & CodTipoNomina & "')"
        Me.DtaAño.Refresh
        ...
        If IsNumeric(Me.TxtAño.Text) Then
            Me.DtaAño.RecordSource = "SELECT Año, Actual, FecIni, FecFin, CodTipoNomina From Año_Actual Where (Año Like '" & Me.TxtAño.Text & "')"
            Me.DtaAño.Refresh
...
Case "Catorcenal los Viernes"
    ...
    'Me.dtaSem.DatabaseName = App.Path + "\PlanQuince.mdb"
        ...
        If Not DtaAño.Recordset.EOF Then
            ...
            'DtaAño.Recordset.Update
        End If
    Me.DtaFecha.RecordSource = "Fecha_Planilla"
    ...
    sIntervalo = CDbl(CSng(Me.TxtAño.Text) / 4)
    ...
    If FechaFin < Me.mskFinal.Value Then
        Do While FechaFin <= Me.mskFinal.Value  'Hay que setear el año actual de planilla OJO
          ...
          If iMes < 26 Then
            ...
            bContMes = 0
            FechaIni = FechaIni + 1
            FechaFin = FechaIni + 13
            Do While iMes < 26 And bContMes < 2
                'GuardarPeriodo
                iMes = iMes + 1
                lstPlanilla.AddItem " " & CStr(iMes) & "   " & CStr(FechaIni) & "  al  " & CStr(FechaFin)
                bContMes = bContMes + 1
                FechaAnterior = FechaIni - 1
                FechaIni = FechaFin
                 
'                Fechafin = Fechafin + FechaQuincenal(bBisiesto, Fechafin) - 1
'
                ...
                If Month(FechaAnterior) = Month(FechaFin) Then
                  iMes = iMes + 1
                  FechaIni = FechaIni + 1
                  lstPlanilla.AddItem " " & CStr(iMes) & "   " & CStr(FechaIni) & "  al  " & CStr(FechaFin)
                   FechaIni = FechaFin
...
'            Do While iMes < 12 'And bContMes < 2
                ...
                iMes = iMes + 1
                 ...
                 FechaFin = DateSerial(iAño, iMes + 1, 0)
                lstPlanilla.AddItem " " & CStr(iMes) & "   " & CStr(FechaIni) & "  al  " & CStr(FechaFin)
'                bContMes = bContMes + 1
'                Fechaini = Fechafin
'                Fechafin = Fechafin + FechaQuincenal(bBisiesto, Fechafin)
...
Dim Fechas As String, Guardado As Boolean
...
iCont = 0
 ...
 Me.DtaAño.RecordSource = "SELECT Año, Actual, CodTipoNomina, FecIni, FecFin From Año_Actual WHERE     (CodTipoNomina = '" & CodTipoNomina & "') AND (Actual = 1)"
 Me.DtaAño.Refresh
 ...
 Case "Semanal Sabado"
        ...
        If IsNumeric(Me.TxtAño.Text) Then
            Me.DtaAño.RecordSource = "SELECT CodTipoNomina,Año, Actual, FecIni, FecFin From Año_Actual Where (Año Like '" & Me.TxtAño.Text & "')AND (CodTipoNomina = '" & CodTipoNomina & "')"
            Me.DtaAño.Refresh
            If Me.DtaAño.Recordset.EOF Then
                Me.DtaAño.Recordset.AddNew
                DtaAño.Recordset("Año") = CInt(TxtAño.Text)
        ...
        Me.DtaFecha.RecordSource = "SELECT CodTipoNomina, Periodo, año, mes, Inicio, Final, Actual From Fecha_Planilla Where  (Inicio = CONVERT(DATETIME, '" & Fechas & "', 102)) AND (CodTipoNomina = '" & CodTipoNomina & "')"
        Me.DtaFecha.Refresh
...
Case "Catorcenal los Viernes"
  ...
  '/////////////////////////////////////////////////////////////////////////////////////////
  '//////////VERIFICO SI ENCUNTRA EL PERIODO////////////////////////////////////////////////
  '/////////////////////////////////////////////////////////////////////////////////////////
...
Case "Quincenal" '/////////////Aqui comiensa el proceso para la PLANILLA QUINCENAL///////////////////////////
        ...
        Me.DtaFecha.RecordSource = "SELECT CodTipoNomina, Periodo, año, mes, Inicio, Final, Actual From Fecha_Planilla Where (Inicio = '" & CDate(FechaIni) & "') AND (CodTipoNomina = '" & CodTipoNomina & "')"
        Me.DtaFecha.Refresh
...
Case "Mensual"
    ...
    Lineas = 1
        ...
        FechaIni = CDate(FechaIni) + 1
        Me.DtaFecha.RecordSource = "SELECT CodTipoNomina, Periodo, año, mes, Inicio, Final, Actual From Fecha_Planilla Where (Inicio = '" & FechaIni & "') AND (CodTipoNomina = '" & CodTipoNomina & "')"
        Me.DtaFecha.Refresh
         FechaIni = CDate(FechaIni) - 1
        If Me.DtaFecha.Recordset.EOF Then
            bEncontrado = False
...
Select Case TipoNomina
 Case "Semanal Sabado"
       Fechas = Format(FechaIni, "YYYY/MM/DD")
        ...
        NFecha2 = FechaFin
        Me.DtaFecha.RecordSource = "SELECT CodTipoNomina, Periodo, año, mes, Inicio, Final, Actual From Fecha_Planilla WHERE     (CodTipoNomina = '02') AND (Inicio = CONVERT(DATETIME, '" & Fechas & "', 102))"
        Me.DtaFecha.Refresh
...
Case "Catorcenal los Sabados"
       ...
       Fechas = Format(FechaIni, "YYYY/MM/DD")
        ...
        Me.DtaFecha.RecordSource = "SELECT CodTipoNomina, Periodo, año, mes, Inicio, Final, Actual From Fecha_Planilla WHERE     (CodTipoNomina = '" & CodTipoNomina & "') AND (Inicio = CONVERT(DATETIME, '" & Fechas & "', 102)) "
'        Me.DtaFecha.RecordSource = "SELECT CodTipoNomina, Periodo, año, mes, Inicio, Final, Actual From Fecha_Planilla Where (Inicio = '" & Fechaini & "') AND (CodTipoNomina = '" & CodTipoNomina & "')"
        Me.DtaFecha.Refresh
...
Case "Mensual"
       Fechas = Format(FechaIni, "YYYY/MM/DD")
        NFecha1 = CDate(FechaIni)
        NFecha2 = CDate(FechaFin)
        Me.DtaFecha.RecordSource = "SELECT CodTipoNomina, Periodo, año, mes, Inicio, Final, Actual From Fecha_Planilla Where (Inicio = '" & Fechas & "') AND (CodTipoNomina = '" & CodTipoNomina & "')"
        Me.DtaFecha.Refresh
        If Not Me.DtaFecha.Recordset.EOF Then
'         Me.DtaFecha.Recordset.Fields("Periodo") = iPeriodo
         Me.DtaFecha.Recordset.Fields("CodTipoNomina") = CodTipoNomina
...
If DtaAño.Recordset.EOF Then
 Me.mskInicio.Value = CDate("01/01/" & Year(Now))
 Me.mskFinal.Value = CDate("31/12/" & Year(Now))
...
Else
 ...
 Me.TxtAño.Text = Year(Me.DtaAño.Recordset("FecFin"))
End If
CmdGenerar_Click
End Sub
...
Me.cmdImprimir.BackColor = RGB(219, 226, 242)
With Me.DtaAño
...
Me.DtaAño.RecordSource = "SELECT Año, Actual, FecIni, FecFin From Año_Actual Where (Actual = 1)"
Me.DtaAño.Refresh
...
Private Sub mskFinal_Change()
 Me.TxtAño.Text = Year(Me.mskFinal.Value)
End Sub
