...
Begin VB.Form FrmTipoNomina 
   ...
   Begin VB.PictureBox Picture1 
      ...
      Top             =   120
      Width           =   9015
      Begin VB.CheckBox ckEmpleadosContruccion 
         Caption         =   "Empleados Contruccion"
         Height          =   375
         Left            =   3480
         TabIndex        =   49
         Top             =   4560
         Width           =   2175
      End
      Begin VB.CheckBox ChkUltimaSemana 
         Caption         =   "Calcular Ir Ultima Semana"
         Height          =   255
         Left            =   3480
         TabIndex        =   48
         Top             =   4320
      ...
      Begin VB.TextBox TxtHoras 
         ...
         Width           =   1695
      End
      Begin VB.CheckBox ChkHorasTrabajadas 
      ...
      Begin VB.Frame Frame6 
         ...
         Begin ACTIVESKINLibCtl.SkinLabel SkinLabel4 
            Height          =   495
            Left            =   120
            OleObjectBlob   =   "FrmTipoNomina.frx":19CF2
            TabIndex        =   38
            Top             =   240
            Width           =   855
         End
      ...
      Do While Not DtaTipoNomina.Recordset.EOF
       If DtaTipoNomina.Recordset("CodTipoNomina") = DBCCodigo.Text Then
         ...
         DtaTipoNomina.Recordset("Periodo") = CmbPeriodo.Text
          ...
          DtaTipoNomina.Recordset("CalcularHoraTrabajada") = Me.ChkHorasTrabajadas.Value
          DtaTipoNomina.Recordset("EmpleadoConstruccion") = Me.ckEmpleadosContruccion.Value
         
         If Not Me.TxtTarifa.Text = "" Then
          DtaTipoNomina.Recordset("TarifaHoraria") = Me.TxtTarifa.Text
         Else
           DtaTipoNomina.Recordset("TarifaHoraria") = 0
         End If
         
         If Me.ChkUltimaSemana.Value = 1 Then
          DtaTipoNomina.Recordset("IrUltimaSemana") = 1
         Else
           DtaTipoNomina.Recordset("IrUltimaSemana") = 0
         End If
         ...
         If Me.Option1.Value = True Then
           DtaTipoNomina.Recordset("TasaInss") = CDbl(Me.TxtPorcentaje.Text)
...
'         DtaTipoNomina.Recordset!HSalida = Me.dtpSalida.Value
'         DtaTipoNomina.Recordset!HEntrada = Me.dtpEntrada.Value
            If Not IsNumeric(Me.TxtHoras.Text) Then
                DtaTipoNomina.Recordset("Horas") = 0
            Else
                DtaTipoNomina.Recordset("Horas") = CDbl(TxtHoras.Text)
            End If
 ...
 'Al ejecutar algun cambio en el combo actualizo el nombre del departamento
   ...
   Do While Not DtaTipoNomina.Recordset.EOF
     If DtaTipoNomina.Recordset("CodTipoNomina") = DBCCodigo.Text Then
        ...
        If Not IsNull(DtaTipoNomina.Recordset("CalcularHoraTrabajada")) Then
         If DtaTipoNomina.Recordset("CalcularHoraTrabajada") = True Then
          Me.ChkHorasTrabajadas.Value = 1
         Else
          Me.ChkHorasTrabajadas.Value = 0
         End If
        Else
         Me.ChkHorasTrabajadas.Value = 0
        End If
        
        If Not IsNull(DtaTipoNomina.Recordset("TarifaHoraria")) Then
          Me.TxtTarifa.Text = DtaTipoNomina.Recordset("TarifaHoraria")
        Else
          Me.TxtTarifa.Text = 0
        End If
        
        If Not IsNull(DtaTipoNomina.Recordset("IrUltimaSemana")) Then
          If DtaTipoNomina.Recordset("IrUltimaSemana") = "Verdadero" Then
           Me.ChkUltimaSemana.Value = 1
          ElseIf DtaTipoNomina.Recordset("IrUltimaSemana") = "True" Then
           Me.ChkUltimaSemana.Value = 1
          Else
           Me.ChkUltimaSemana.Value = 0
          End If
         
        End If
        
        
        If Not IsNull(DtaTipoNomina.Recordset("EmpleadoConstruccion")) Then
          If DtaTipoNomina.Recordset("EmpleadoConstruccion") = "Verdadero" Then
           Me.ckEmpleadosContruccion.Value = 1
          ElseIf DtaTipoNomina.Recordset("EmpleadoConstruccion") = "True" Then
           Me.ckEmpleadosContruccion.Value = 1
          Else
           Me.ckEmpleadosContruccion.Value = 0
          End If
...
'        Me.dtpSalida.Value = Me.DtaTipoNomina.Recordset!HSalida
'        Me.dtpEntrada.Value = Me.DtaTipoNomina.Recordset!HEntrada
...
With Me.DtaTipoNomina
   ...
   .RecordSource = "SELECT     *  FROM         TipoNomina"
   .Refresh
End With
...
Private Sub TxtInssPatronal_Change()
 res = Bitacora(Now, NombreUsuario, "Tipo Nomina", "Se Modifico el Porcentaje Inss Patronal, Tipo Nomina: " & Me.DBCCodigo.Text)
End Sub

Private Sub txtPorcentaje_Change()
 res = Bitacora(Now, NombreUsuario, "Tipo Nomina", "Se Modifico el Porcentaje Inss Laboral, Tipo Nomina: " & Me.DBCCodigo.Text)
End Sub
