...
Begin VB.Form frmPlantacion 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Administrador de Plantaciones"
   ClientHeight    =   5085
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   6870
   ...
   Begin VB.Frame Frame1 
      ...
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel1 
         Height          =   375
         Left            =   120
         OleObjectBlob   =   "frmPlantacion.frx":0000
         TabIndex        =   6
         Top             =   240
         Width           =   975
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel2 
         Height          =   375
         Left            =   120
         OleObjectBlob   =   "frmPlantacion.frx":0062
         TabIndex        =   7
         Top             =   600
         Width           =   975
      End
   ...
   End
End
Attribute VB_Name = "frmPlantacion"
...
Else        'CODIGO PARA GRABAR DATOS
    If Me.txtGrupo.Text = "" Then
        MsgBox "La descripción de la Plantación es requerida", vbInformation
        Me.txtGrupo.SetFocus
        Exit Sub
    End If
    ...
    If Me.CmdEditar.Caption = "Save..." Then
        sql = "INSERT INTO _Plantacion(Plantacion) VALUES('" & Me.txtGrupo & "')"
    Else
        filt = "IdPlantacion = " & val(Me.txtId)
        sql = "UPDATE _Plantacion SET Plantacion = '" & Me.txtGrupo & "' WHERE IdPlantacion = " & rs!IdPlantacion
    End If
...
If Me.CmdBorrar.Caption = "&Borrar" Then
    ...
    If MsgBox("¿Desea eliminar el registro?", vbYesNo) = vbYes Then
        sql = "DELETE FROM _Plantacion WHERE IdPlantacion = " & val(rs!IdPlantacion)
        cnx.Execute sql
        Call rsUpdate
...
Me.tdbgGrupo.Columns(0).AutoSize
Me.tdbgGrupo.Columns(1).AutoSize
...
On Error Resume Next
Set cols = tdbgGrupo.Columns
Dim c As Integer

c = tdbgGrupo.col
tdbgGrupo.HoldFields
sql = rs.Filter
rs.Filter = getFilter(col, cols)

tdbgGrupo.col = c
tdbgGrupo.EditActive = True
End Sub
