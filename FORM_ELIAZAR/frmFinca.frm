...
Begin VB.Form frmFinca 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Administrador de Fincas"
   ClientHeight    =   5145
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   7080
   ...
   Begin VB.Frame Frame1 
      ...
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel1 
         Height          =   375
         Left            =   120
         OleObjectBlob   =   "frmFinca.frx":0000
         TabIndex        =   6
         Top             =   240
         Width           =   975
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel2 
         Height          =   375
         Left            =   120
         OleObjectBlob   =   "frmFinca.frx":0062
         TabIndex        =   7
         Top             =   600
         Width           =   975
      End
...
Else        'CODIGO PARA GRABAR DATOS
    If Me.txtGrupo.Text = "" Then
        MsgBox "La descripción de la finca es requerida", vbInformation
        Me.txtGrupo.SetFocus
        Exit Sub
    End If
    ...
    If Me.CmdEditar.Caption = "Save..." Then
        sql = "INSERT INTO _Finca(Finca) VALUES('" & Me.txtGrupo & "')"
    Else
        filt = "IdFinca = " & val(Me.txtId)
        sql = "UPDATE _Finca SET Finca = '" & Me.txtGrupo & "' WHERE IdFinca = " & rs!IdFinca
    End If
...
If Me.CmdBorrar.Caption = "&Borrar" Then
    ...
    If MsgBox("¿Desea eliminar el registro?", vbYesNo) = vbYes Then
        sql = "DELETE FROM _Finca WHERE IdFinca = " & val(rs!IdFinca)
        cnx.Execute sql
        Call rsUpdate
